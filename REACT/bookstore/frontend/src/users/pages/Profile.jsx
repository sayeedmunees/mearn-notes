...
const Profile = () => {
  ...
  return (
    <>
      ...
      {bookStatus && (
        <div className="p-10 my-20 rounded">
          {userBooks?.length > 0 ? (
            userBooks.map((item) => (
              <div className="bg-gray-200 p-4 rounded m-2 my-4">
                <div className="md:grid grid-cols-[3fr_1fr]">
                  ...
                  <div>
                    <img
                      src={
                        item?.imageurl ||
                        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSIgFsPvKjCc9OhYq89CL6PjUbk7kLFQIHH7A&s"
                      }
                      alt=""
                      className="w-full"
                      style={{ height: "400px" }}
                    ...
                    <div className="flex justify-end mt-4">
                      <button
                        ...
                        className="bg-red-500 rounded text-white p-3 hover:bg-white hover:border hover:border-red-500 hover:text-red-500 ms-3"
                      >
                        Delete
                      </button>
                    </div>
      ...
      {purchaseStatus && (
        <div className="p-10 my-20 rounded">
          {userBroughtBooks?.length > 0 ? (
            ...
            <div className="flex justify-start items-center -mt-30 flex-col">
              <img
                style={{ width: "400px", height: "400px" }}
                src="https://i.pinimg.com/originals/39/70/fd/3970fd45f8264338153834f7ff18f4f0.gif"
                alt="noimage"
              />
              <p className="text-red-600 text-4xl">No Books Purchased Yet!!</p>
            </div>
          )}
        </div>
      )}
